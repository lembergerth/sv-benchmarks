...
{ 
  ...
  {
  if ((unsigned long )(vdev->config)->generation != (unsigned long )((u32 (*/* const  */)(struct virtio_device * ))0)) {
    {
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_virtio_blk_vq == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_virtio_blk_vq == 2);
