...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_bpoll_lock_of_vnic_rq == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_bpoll_lock_of_vnic_rq == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_devcmd_lock_of_enic == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_devcmd_lock_of_enic == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_enic_api_lock_of_enic == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_enic_api_lock_of_enic == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_enic_rfs_flw_tbl == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_enic_rfs_flw_tbl == 2);
