...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_nx_host_rds_ring == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_nx_host_rds_ring == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_mem_lock_of_netxen_hardware_context == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_mem_lock_of_netxen_hardware_context == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_tx_clean_lock_of_netxen_adapter == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_tx_clean_lock_of_netxen_adapter == 2);
