...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_reg_lock_of_snd_ice1712 == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_reg_lock_of_snd_ice1712 == 2);
