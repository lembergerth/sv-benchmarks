...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_amd8111e_priv == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_amd8111e_priv == 2);
