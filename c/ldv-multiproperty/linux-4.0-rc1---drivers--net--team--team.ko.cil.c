...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_mode_list_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_mode_list_lock == 2);
