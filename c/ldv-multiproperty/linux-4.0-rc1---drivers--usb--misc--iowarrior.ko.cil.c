...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_intr_idx_lock_of_iowarrior == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_intr_idx_lock_of_iowarrior == 2);
