...
{ 
  ...
  assume_abort_if_not((unsigned long )ldv_0_size_cnt_struct_block_device_ptr <= (unsigned long )((struct block_device *)2147479552));
  }
...
{ 
  ...
  assume_abort_if_not((unsigned long )ldv_1_size_cnt_struct_block_device_ptr <= (unsigned long )((struct block_device *)2147479552));
  }
...
{ 
  ...
  assume_abort_if_not((unsigned long )ldv_2_size_cnt_struct_block_device_ptr <= (unsigned long )((struct block_device *)2147479552));
  }
...
{ 
  ...
  if (tmp != 0) {
    {
    assume_abort_if_not((unsigned int )ldv_4_ret_val_default == 2U);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_dev_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_dev_lock == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rssd_index_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rssd_index_lock == 2);
