...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_dmxdev == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_dmxdev == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_dvb_demux == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_dvb_demux == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_dvb_ringbuffer == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_dvb_ringbuffer == 2);
