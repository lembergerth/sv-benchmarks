...
{ 
  ...
  if (tmp___3 != 0) {
    {
    assume_abort_if_not(ldv_12_started_default == 1);
    tmp = ldv_undef_int();
    }
    {
    if (tmp == 1) {
    ...
    {
    assume_abort_if_not(ldv_12_started_default == 0);
    tmp___2 = ldv_undef_int();
    }
    if (tmp___2 != 0) {
      {
...
{ 
  ...
  if (tmp___3 != 0) {
    {
    assume_abort_if_not(ldv_13_started_default == 1);
    tmp = ldv_undef_int();
    }
    {
    if (tmp == 1) {
    ...
    {
    assume_abort_if_not(ldv_13_started_default == 0);
    tmp___2 = ldv_undef_int();
    }
    if (tmp___2 != 0) {
      {
