...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_q_lock_of_msb_data == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_q_lock_of_msb_data == 2);
