...
int main(void)
{
    if (!(__builtin_isgreaterequal(2.0, 1.0))) __VERIFIER_error();
    if (!(!__builtin_isgreaterequal(1.0, 2.0))) __VERIFIER_error();
    if (!(__builtin_isgreaterequal(1.0, 1.0))) __VERIFIER_error();
    if (!(__builtin_isgreaterequal((__builtin_inff()), 1.0))) __VERIFIER_error();
    if (!(!__builtin_isgreaterequal(1.0, (__builtin_nanf (""))))) __VERIFIER_error();
