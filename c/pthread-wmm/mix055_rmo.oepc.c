...
void * P0(void *arg)
{
  ...
  a$w_buff0_used = TRUE;
  if (!(!(a$w_buff1_used && a$w_buff0_used))) __VERIFIER_error();
...
{
  pthread_t t1473;
  pthread_create(&t1473, NULL, P0, NULL);
  pthread_t t1474;
  pthread_create(&t1474, NULL, P1, NULL);
  pthread_t t1475;
  pthread_create(&t1475, NULL, P2, NULL);
  pthread_t t1476;
  pthread_create(&t1476, NULL, P3, NULL);
  __VERIFIER_atomic_begin();
