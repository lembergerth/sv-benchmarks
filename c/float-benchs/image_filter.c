...
int main() 
{
  ...
  if (!(y1 >= -1. && y1 <= 1.)) __VERIFIER_error();
  if (!(y2 >= -1. && y2 <= 1.)) __VERIFIER_error();
  if (!(y3 >= -1. && y3 <= 1.)) __VERIFIER_error();
  if (!(y4 >= -1. && y4 <= 1.)) __VERIFIER_error();
  if (!(y5 >= -1. && y5 <= 1.)) __VERIFIER_error();
  if (!(y6 >= -1. && y6 <= 1.)) __VERIFIER_error();
  if (!(y7 >= -1. && y7 <= 1.)) __VERIFIER_error();
  if (!(y8 >= -1. && y8 <= 1.)) __VERIFIER_error();
  if (!(y9 >= -1. && y9 <= 1.)) __VERIFIER_error();
  if (!(y10 >= -1. && y10 <= 1.)) __VERIFIER_error();
  if (!(y11 >= -1. && y11 <= 1.)) __VERIFIER_error();
  if (!(y12 >= -1. && y12 <= 1.)) __VERIFIER_error();
  if (!(y13 >= -1. && y13 <= 1.)) __VERIFIER_error();
  if (!(y14 >= -1. && y14 <= 1.)) __VERIFIER_error();
  if (!(y15 >= -1. && y15 <= 1.)) __VERIFIER_error();
  if (!(y16 >= -1. && y16 <= 1.)) __VERIFIER_error();
  if (!(y17 >= -1. && y17 <= 1.)) __VERIFIER_error();
  if (!(y18 >= -1. && y18 <= 1.)) __VERIFIER_error();
  if (!(y19 >= -1. && y19 <= 1.)) __VERIFIER_error();
  return 0;
}
