...
void qsort(void *base, unsigned long num, unsigned long size, int (*compar)(const void *, const void *)) {
    ...
    __VERIFIER_assume(index_a < num);
    unsigned long index_b;
    __VERIFIER_assume(index_b < num);
    __VERIFIER_assume(index_a != index_b);
...
int compare(const void *a, const void *b, size_t item_size) {
    __VERIFIER_assume((((item_size) == 0) || (a)));
    __VERIFIER_assume((((item_size) == 0) || (b)));
    return nondet_int();
}
