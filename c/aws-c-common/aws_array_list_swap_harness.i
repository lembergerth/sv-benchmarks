...
void aws_array_list_swap_harness() {
    ...
    __VERIFIER_assume(index_a < aws_array_list_length(&list));
    __VERIFIER_assume(index_b < aws_array_list_length(&list));
    ...
    if (!(aws_array_list_is_valid(&list))) __VERIFIER_error();
    if (!(list.alloc == old.alloc)) __VERIFIER_error();
    if (!(list.current_size == old.current_size)) __VERIFIER_error();
    if (!(list.length == old.length)) __VERIFIER_error();
    if (!(list.item_size == old.item_size)) __VERIFIER_error();
}
